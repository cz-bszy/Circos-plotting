function transform_connections_script(links,threshold,region,link_name)

fileID = fopen(region,'r');
...
for i = 1:height(links)
    ...
    [color, value] = assign_color_value(links.source_network{i});
...
function [color, value] = assign_color_value(network)
% link_color=[211,211,211];
